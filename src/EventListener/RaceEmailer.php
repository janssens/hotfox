...
class RaceEmailer implements EventSubscriberInterface
{
    ...
    protected function sendNewRaceEmail(Race $race){
        $instructors = $this->em->getRepository(Instructor::class)->findBy(['is_active'=>true]);
